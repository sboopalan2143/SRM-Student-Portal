...
class ProfileHiveDataAdapter extends TypeAdapter<ProfileHiveData> {
  @override
  final int typeId = 0;

  @override
  ProfileHiveData read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return ProfileHiveData(
  ...
  @override
  void write(BinaryWriter writer, ProfileHiveData obj) {
    writer
      ..writeByte(15)
      ..writeByte(0)
  ...
  bool operator ==(Object other) =>
      ...
      other is ProfileHiveDataAdapter &&
