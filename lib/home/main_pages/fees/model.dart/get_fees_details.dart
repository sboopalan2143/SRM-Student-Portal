...
class FeesDueDetails {
  String? status;
  String? message;
  List<GetFeesData>? data;

  FeesDueDetails({this.status, this.message, this.data});

  FeesDueDetails.fromJson(Map<String, dynamic> json) {
    status = json['Status'] as String?;
    message = json['Message'] as String?;
    if (json['Data'] != null) {
      data = <GetFeesData>[];
      json['Data'].forEach((v) {
        data!.add(new GetFeesData.fromJson(v as Map<String, dynamic>));
      });
    }
  }
