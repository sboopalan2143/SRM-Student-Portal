...
//                   isMe:
//                       index % 2 == 0, // Alternates between sender and receiver
//                 );
//               },
//             ),
//           ),
        ...
        return Card(
          ...
          child: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('asdf', style: TextStyle(fontWeight: FontWeight.bold)),
                SizedBox(height: 4),
                Text(('Text')),
                SizedBox(height: 8),
                if ('Text'.isNotEmpty)
