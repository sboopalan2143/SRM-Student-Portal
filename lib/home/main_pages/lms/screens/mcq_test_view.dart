...
//     // log('answers >>> $answers');
//     // log('Answer value >>> $answerSelected');

//     final String singleString = answerSelected.join(',');

//     // log('singleString >> $singleString');
//     // final answerdec = "${provider.mcqQuestionAndAnswerData[index].questionid!}~${selectedAnswers}"
...
//                         onChanged: (value) {
//                           setState(() {
//                             // log('selectedAnswer value >>> $value');
//                             selectedAnswers[index] = value!;
//                             answerSelected.add(
//                                 '''${provider.mcqQuestionAndAnswerData[index].questionid}~${answerOptions[j][0]}~${answerOptions[j][2]}~${answerOptions[j][1]}~${provider.mcqQuestionAndAnswerData[index].questionid}~-''');
//                           });
//                         },
...
class _McqTestViewPageState extends ConsumerState<McqTestViewPage> {
  ...
  // Move singleString here as a global value
  String singleString = '';
