...
class Theme01Page extends ConsumerStatefulWidget {
  const Theme01Page({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _Theme01PageState();
}

class _Theme01PageState extends ConsumerState<Theme01Page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: BoxDecoration(color: AppColors.theme01secondaryColor4),
        child: Padding(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Image.asset(
                          'assets/images/slectedtheme01.png',
                          width: 150,
                          height: 250,
                        ),
                      ),
