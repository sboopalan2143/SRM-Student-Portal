...
class Theme02CalendarStatusPage extends ConsumerStatefulWidget {
  const Theme02CalendarStatusPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _Theme02CalendarStatusPageState();
}

class _Theme02CalendarStatusPageState
    extends ConsumerState<Theme02CalendarStatusPage> {
                  ...
                  Expanded(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            '${provider.calendarCurrentDateData[index].day}' ==
                                    ''
                                ? '-'
                                : '${provider.calendarCurrentDateData[index].day}',
                            style: TextStyle(
              ...
              if (provider is CalendarStateLoading) ...[
                ...
                Padding(
                  ...
                  child: ListView.builder(
                    itemCount: provider.calendarCurrentDateData.length,
                    controller: _listController,
                    shrinkWrap: true,
                    itemBuilder: (BuildContext context, int index) {
                      final formattedDate =
                          DateFormat('dd-MM-yyyy').format(DateTime.now());
                      log('date >>> ${provider.calendarHiveData[index].date}');
