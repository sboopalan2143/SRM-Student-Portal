...
class Theme06InternalMarksPage extends ConsumerStatefulWidget {
  const Theme06InternalMarksPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _Theme06InternalMarksPageState();
}

class _Theme06InternalMarksPageState
    extends ConsumerState<Theme06InternalMarksPage> {
