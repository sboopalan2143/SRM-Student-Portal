...
class Theme06LeaveApplicationPage extends ConsumerStatefulWidget {
  const Theme06LeaveApplicationPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _Theme62LeaveApplicationPageState();
}

class _Theme62LeaveApplicationPageState
    extends ConsumerState<Theme06LeaveApplicationPage> {
