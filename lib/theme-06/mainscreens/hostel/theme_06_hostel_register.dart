...
class Theme06RegistrationPage extends ConsumerStatefulWidget {
  const Theme06RegistrationPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _Theme06RegistrationPageState();
}

class _Theme06RegistrationPageState
    extends ConsumerState<Theme06RegistrationPage> {
