...
import 'package:sample/theme-06/mainscreens/library/library_search_screen.dart';
// import 'package:sample/home/riverpod/main_state.dart';

class Theme06LibraryPage extends ConsumerStatefulWidget {
  const Theme06LibraryPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _Theme06LibraryPageState();
}
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              RouteDesign(
                                route: const Theme06LibraryBookSearch(),
                              ),
                            );
                          },
                          child: const Text(
