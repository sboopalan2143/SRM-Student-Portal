...
import 'package:sample/theme-06/mainscreens/lms/lms_attachment_screen.dart';
import 'package:sample/theme-06/mainscreens/lms/lms_entry_test_screen.dart';
import 'package:sample/theme-06/mainscreens/lms/lms_save_attachment.dart';
import 'package:sample/theme-06/mainscreens/lms/lms_student_attachment_screen.dart';

class Theme06LmsClassworkDetailPage extends ConsumerStatefulWidget {
  const Theme06LmsClassworkDetailPage({
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _Theme62LmsClassworkDetailPageState();
}

class _Theme62LmsClassworkDetailPageState
    extends ConsumerState<Theme06LmsClassworkDetailPage> {
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            RouteDesign(
                              route: Theme06LmsAttachmentDetailsDataPage(
                                classworkID:
                                    '${provider.classWorkDetailsData[index].classworkid}',
                              ),
                            ),
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            RouteDesign(
                              route: Theme06LmsStudentAttachmentDetailsDataPage(
                                classworkreplyid:
                                    '${provider.classWorkDetailsData[index].classworkreplyid}',
                              ),
                            ),
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              RouteDesign(
                                route: Theme06LmsSaveWorkReplayDetailsDataPage(
                                  classworkID:
                                      '${provider.classWorkDetailsData[index].classworkid}',
                                  classworkreplyid:
                                      '${provider.classWorkDetailsData[index].classworkreplyid}',
