...
class Theme06McqTestViewPage extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _Theme62McqTestViewPageState();
}

class _Theme62McqTestViewPageState
    extends ConsumerState<Theme06McqTestViewPage> {
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            await Navigator.push(
                              context,
                              RouteDesign(
                                route: const Theme06McqGetAnswerPage(),
                              ),
                            );
                          },
                          child: Container(
