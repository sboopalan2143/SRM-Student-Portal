...
class Theme06LmsStudentAttachmentDetailsDataPage
    extends ConsumerStatefulWidget {
  const Theme06LmsStudentAttachmentDetailsDataPage({
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      Theme06LmsStudentAttachmentDetailsDataPageState();
}

class Theme06LmsStudentAttachmentDetailsDataPageState
