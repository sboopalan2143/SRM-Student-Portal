...
import 'package:sample/theme-06/mainscreens/lms/lms_classwork_detail_screen.dart';
import 'package:sample/theme-06/mainscreens/lms/lms_comment_screen.dart';
import 'package:sample/theme-06/mainscreens/lms/lms_faculty_comment_screen.dart';

class Theme06LmsTitlePage extends ConsumerStatefulWidget {
  const Theme06LmsTitlePage({
                    ...
                    _buildActionButton(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          RouteDesign(
                            route: Theme06LmsClassworkDetailPage(
                              classworkID:
                                  '${provider.lmsTitleData[index].classworkid}',
                            ),
                          ),
                      ...
                      _buildActionButton(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            RouteDesign(
                              route: Theme026msFacultyCommentScreen(
                                classworkID:
                                    '${provider.lmsTitleData[index].classworkid}',
                              ),
                            ),
