...
class Theme06Page extends ConsumerStatefulWidget {
  const Theme06Page({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _Theme06PageState();
}

class _Theme06PageState extends ConsumerState<Theme06Page> {
