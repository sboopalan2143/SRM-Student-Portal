...
class Theme06settingPage extends ConsumerStatefulWidget {
  const Theme06settingPage({super.key});

  @override
  ConsumerState createState() => _Theme06settingPageState();
}

class _Theme06settingPageState extends ConsumerState<Theme06settingPage>
