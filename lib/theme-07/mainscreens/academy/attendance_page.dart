...
import 'package:sample/theme-07/mainscreens/academy/hour_wise_atttendance.dart';
import 'package:sample/theme-07/mainscreens/academy/sub_wise_attendance.dart';
...
class Theme07AttendanceHomePage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _Theme07AttendanceHomePageState();
}
...
class _Theme07AttendanceHomePageState extends ConsumerState<Theme07AttendanceHomePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await ref
          ...
          .getDhasboardOverallAttendanceDetails(ref.read(encryptionProvider.notifier));
  ...
  Widget cardDesignAttendanceHrs() {
    ...
    final presentPercentage = totalSessions > 0 ? (present / totalSessions) : 0.0;
