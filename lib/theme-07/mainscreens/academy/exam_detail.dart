...
class Theme07ExamDetailsPageTheme extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _Theme07ExamDetailsPageThemeState();
}

class _Theme07ExamDetailsPageThemeState extends ConsumerState<Theme07ExamDetailsPageTheme> {
          ...
          children: [
            ...
            SingleChildScrollView(
              child: Column(
                children: [
                  for (int i = 8; i >= 1; i--) ...[
                    if (provider.examDetailsHiveData.any((data) => data.semester == '$i')) ...[
                      Container(
                        ...
                        child: Theme(
                          ...
                          child: ExpansionTile(
                            ...
                            children: [
                              ...provider.examDetailsHiveData.where((data) => data.semester == '$i').map((data) {
                                final index = provider.examDetailsHiveData.indexOf(data);
                ...
                children: [
                  ...
                  SizedBox(
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 14,
                        color: provider.examDetailsHiveData[index].result == 'PASS' ? Colors.green : Colors.red,
                        fontWeight: FontWeight.bold,
                      ),
                    ),
                  ),
