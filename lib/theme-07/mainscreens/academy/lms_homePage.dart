...
class Theme07LmsHomePage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _Theme07LmsHomePageState();
}
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              else if (provider.lmsSubjectData.isEmpty && provider is! LmsStateLoading)
                Column(
                  children: [
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _infoRow(Icons.code, 'Course Code', provider.lmsSubjectData[index].subjectcode),
                const SizedBox(height: 8),
                _infoRow(Icons.person, 'Staff', provider.lmsSubjectData[index].staffname),
              ],
            ),
          ),
