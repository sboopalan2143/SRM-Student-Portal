...
//                             width: width / 3.5,
//                             child:Text(
//                               '${provider.listHourWiseHiveData[index].attendancedate!.split('#')[0]}',
...
//                             style: TextStyle(
//                               fontSize: 14,
//                               color:  provider.listHourWiseHiveData[index].h1 == 'A'
//                                   ? AppColors.redColor
//                                   : provider.listHourWiseHiveData[index]
//                                   .h1 ==
//                                   'P'
...
//                             style: TextStyle(
//                               fontSize: 14,
//                               color: provider.listHourWiseHiveData[index].h2 == 'A'
//                                   ? AppColors.redColor
//                                   : provider.listHourWiseHiveData[index]
//                                   .h2 ==
//                                   'P'
...
//                             style: TextStyle(
//                               fontSize: 14,
//                               color:  provider.listHourWiseHiveData[index].h3 == 'A'
//                                   ? AppColors.redColor
//                                   : provider.listHourWiseHiveData[index]
//                                   .h3 ==
//                                   'P'
...
//                             style: TextStyle(
//                               fontSize: 14,
//                               color: provider.listHourWiseHiveData[index].h5 == 'A'
//                                   ? AppColors.redColor
//                                   : provider.listHourWiseHiveData[index]
//                                   .h5 ==
//                                   'P'
...
//                             style: TextStyle(
//                               fontSize: 14,
//                               color: provider.listHourWiseHiveData[index].h6 == 'A'
//                                   ? AppColors.redColor
//                                   : provider.listHourWiseHiveData[index]
//                                   .h6 ==
//                                   'P'
...
//                             style: TextStyle(
//                               fontSize: 14,
//                               color: provider.listHourWiseHiveData[index].h7 == 'A'
//                                           ? AppColors.redColor
//                                           : provider.listHourWiseHiveData[index]
//                                                       .h7 ==
//                                                   'P'
...
class _Theme07HourAttendancePageState
  ...
  Map<String, List<dynamic>> groupByMonth(List<dynamic> data) {
    ...
    for (var item in data) {
      String date = '${item.attendancedate!.split('#')[0]}';
      String month = date.split('-')[1]; // Extract month from date
  ...
  Widget build(BuildContext context) {
    ...
    groupByMonth(provider.listHourWiseHiveData);
