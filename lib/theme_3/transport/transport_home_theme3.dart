...
class TransportHomeTheme3 extends ConsumerStatefulWidget {
  const TransportHomeTheme3({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _TransportHomeTheme3State();
}

class _TransportHomeTheme3State extends ConsumerState<TransportHomeTheme3> {
  ...
  Widget getScreen() {
    switch (currentItem) {
      case MenuItems.home:
        return const TransportRegisterPageTheme3();
      case MenuItems.main:
      default:
