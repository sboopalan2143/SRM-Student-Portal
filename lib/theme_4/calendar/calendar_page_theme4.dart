...
class CalendarPageTheme4 extends ConsumerStatefulWidget {
  const CalendarPageTheme4({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _CalendarPageTheme4State();
}

class _CalendarPageTheme4State extends ConsumerState<CalendarPageTheme4> {
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          gradient: provider.calendarHiveData[index].holidaystatus == '0'
              ? AppColors.primaryColorTheme4
