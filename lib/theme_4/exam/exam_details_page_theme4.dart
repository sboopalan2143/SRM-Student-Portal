...
class ExamDetailsPageTheme4 extends ConsumerStatefulWidget {
  const ExamDetailsPageTheme4({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ExamDetailsPageTheme4State();
}

class _ExamDetailsPageTheme4State extends ConsumerState<ExamDetailsPageTheme4> {
      ...
      child: Column(
        ...
        children: [
          ...
          LinearPercentIndicator(
            ...
            progressColor: AppColors.theme4color3,
          ),
          const SizedBox(height: 10),
          Row(
            children: [
