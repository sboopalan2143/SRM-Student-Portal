...
import 'package:sample/theme_4/hostel/hostel_leave_reg_page_theme4.dart';
import 'package:sample/theme_4/hostel/hostel_reg_page_theme4.dart';

class HostelPageTheme4 extends ConsumerStatefulWidget {
  const HostelPageTheme4({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _HostelPageTheme4State();
}

class _HostelPageTheme4State extends ConsumerState<HostelPageTheme4> {
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              RouteDesign(
                                route: const LeaveApplicationPageTheme4(),
                              ),
                            );
                          },
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              RouteDesign(
                                route: const RegistrationPageTheme4(),
                              ),
                            );
                          },
                          child: const FittedBox(
