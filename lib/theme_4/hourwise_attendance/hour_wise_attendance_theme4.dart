...
class HourAttendancePageTheme4 extends ConsumerStatefulWidget {
  const HourAttendancePageTheme4({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _HourAttendancePageTheme4State();
}

class _HourAttendancePageTheme4State
    extends ConsumerState<HourAttendancePageTheme4> {
                      ...
                      children: [
                        ...
                        badges.Badge(
                          badgeStyle: const badges.BadgeStyle(
                            ...
                            badgeColor: AppColors.theme4color2,
                          ),
