...
class LibraryBookSearchTheme4 extends ConsumerStatefulWidget {
  const LibraryBookSearchTheme4({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _LibraryBookSearchTheme4State();
}

class _LibraryBookSearchTheme4State
    extends ConsumerState<LibraryBookSearchTheme4> {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const Divider(height: 1, color: AppColors.blackColor)
        ],
      ),
    );
  }
