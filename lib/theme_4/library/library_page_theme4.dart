...
import 'package:sample/theme_4/library/library_booksearch_theme4.dart';

class LibraryPageTheme4 extends ConsumerStatefulWidget {
  const LibraryPageTheme4({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _LibraryPageTheme4State();
}

class _LibraryPageTheme4State extends ConsumerState<LibraryPageTheme4> {
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              RouteDesign(
                                route: const LibraryBookSearchTheme4(),
                              ),
                            );
                          },
                          child: const Text(
