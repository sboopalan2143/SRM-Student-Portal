...
import 'package:sample/theme_4/lms/lms_attachment_detail_theme4.dart';
import 'package:sample/theme_4/lms/lms_save_work_reply_theme4.dart';
import 'package:sample/theme_4/lms/lms_student_attachment_screen_theme4.dart';
import 'package:sample/theme_4/lms/mcq_entry_page_theme4.dart';
// import 'package:sample/home/riverpod/main_state.dart';

class LmsClassworkDetailPageTheme4 extends ConsumerStatefulWidget {
  const LmsClassworkDetailPageTheme4({
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _LmsClassworkDetailPageTheme4State();
}

class _LmsClassworkDetailPageTheme4State
    extends ConsumerState<LmsClassworkDetailPageTheme4> {
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            RouteDesign(
                              route: LmsStudentAttachmentDataPageTheme4(
                                classworkreplyid:
                                    '${provider.classWorkDetailsData[index].classworkreplyid}',
                              ),
                            ),
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            RouteDesign(
                              route: LmsSaveWorkReplayDataPageTheme4(
                                classworkID:
                                    '${provider.classWorkDetailsData[index].classworkid}',
                                classworkreplyid:
                                    '${provider.classWorkDetailsData[index].classworkreplyid}',
